...
/*
     ...
     Student student2=new Student(2,"somnath")
	...
	*/
	 ...
	 * if two objects have different hashcode, they should not be equal
	 * if two objects have same hashcode , the objects may be or may not be equal
	 */
	@Override
	public int hashCode() {
		return id;
